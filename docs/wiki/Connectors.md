...
subprocess. For GitHub App setup specifically, see [GitHub App setup](https://github.com/NodeSpy/conductor-plugins/blob/main/docs/connectors/github-app-setup.md).
