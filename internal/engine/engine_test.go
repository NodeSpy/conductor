...
func (*fakeDispatcher) DeliverOutput(string, map[string]any) (bool, error) { return false, nil }

func (*gateFake) DeliverOutput(string, map[string]any) (bool, error) { return false, nil }
