...
func (a *fakeAgents) background(ctx context.Context, t core.Trigger, stepID, agentName string, p config.Step, ref dispatch.RunRef, handoffConn string, redispatch func(context.Context) (dispatch.RunRef, error)) {
	a.mu.Lock()
	defer a.mu.Unlock()
